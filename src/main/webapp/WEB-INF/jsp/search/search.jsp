		...
		<section>
			...
			<div class="my-3 p-3 bg-body rounded shadow-sm">
			    ...
			    <div class="d-flex text-muted pt-3">
			      ...
			      <p class="pb-3 mb-0 small lh-sm border-bottom">
			        <strong class="d-block text-gray-dark">@${postHashtagResult.userNickname }</strong>
			        <a href="/post/detail_view?id=${postHashtagResult.id }">${postHashtagResult.title }</a>
			      </p>
			    </div>
			    </c:forEach>
			...
			<c:choose>
				...
				<div class="my-3 p-3 bg-body rounded shadow-sm">
				    ...
				    <div class="d-flex text-muted pt-3">
				      <img src="${userHashtagResult.profileImagePath }" class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="32" height="32">
				
				      <p class="pb-3 mb-0 small lh-sm border-bottom">
				        @<a href="/user/profile/profile_view?id=${userHashtagResult.id }">${userHashtagResult.nickname }</a>
				      </p>
				    </div>
				    </c:forEach>
