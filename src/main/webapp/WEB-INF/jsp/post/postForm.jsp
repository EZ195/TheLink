		...
		<section>
			<form>
				...
				<div class="btn-group btn-group-sm mt-3">
					...
					<h5>문화·예술</h5>
						<input type="radio" class="btn-check mt-3" name="category" id="culture1" value="culture_전시">
					  	<label class="btn btn-outline-danger" for="culture1">전시</label>
					
						<input type="radio" class="btn-check" name="category" id="culture2" value="culture_영화">
						<label class="btn btn-outline-danger" for="culture2">영화</label>
											
						<input type="radio" class="btn-check" name="category" id="culture3" value="culture_뮤지컬">
						<label class="btn btn-outline-danger" for="culture3">뮤지컬</label>
							
						<input type="radio" class="btn-check" name="category" id="culture4" value="culture_공연">
						<label class="btn btn-outline-danger" for="culture4">공연</label>					

						<input type="radio" class="btn-check" name="category" id="culture5" value="culture_디자인">
						<label class="btn btn-outline-danger" for="culture5">디자인</label>	
						
						<input type="radio" class="btn-check" name="category" id="culture6" value="culture_박물관">
						<label class="btn btn-outline-danger" for="culture6">박물관</label>	
						
						<input type="radio" class="btn-check" name="category" id="culture7" value="culture_연극">
						<label class="btn btn-outline-danger" for="culture7">연극</label>	
					
						<input type="radio" class="btn-check" name="category" id="culture8" value="culture_콘서트">
				...
				<div class="btn-group btn-group-sm mt-3">
					<div class="form-check">
						...
						<input type="radio" class="btn-check" name="category" id="activity16" value="탁구">
						<label class="btn btn-outline-danger" for="activity16">탁구</label>
						
						<input type="radio" class="btn-check" name="category" id="activity17" value="볼링">
						<label class="btn btn-outline-danger" for="activity17">볼링</label>
						
						<input type="radio" class="btn-check" name="category" id="activity18" value="골프">
						<label class="btn btn-outline-danger" for="activity18">골프</label>
						
						<input type="radio" class="btn-check" name="category" id="activity19" value="스포츠경기">
